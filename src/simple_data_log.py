...
# Description: This script is primarily for basic data logging using UR10e robot, ATI sensors, and pressure sensor packets.
...
def main(args):
  ...
  # controller node
  rospy.init_node('suction_experiment')
  ...
  rospy.sleep(0.5)
  file_help = fileSaveHelp() # you can change parent folder name with fileSaveHelp(savingFolderName = 'Suction_Experiment'
  ...
  try:
    ...
    input("Press <Enter> to offset data")
