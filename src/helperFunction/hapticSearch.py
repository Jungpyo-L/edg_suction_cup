...
class hapticSearchHelp(object):
    def __init__(self,dP_threshold=20, dw=15, P_vac = -15000, d_lat = 5e-3, d_z= 1.5e-3, n = 4):   #original
    ...
    def get_lateral_direction_vector(self, P_array, rotation_angle):
