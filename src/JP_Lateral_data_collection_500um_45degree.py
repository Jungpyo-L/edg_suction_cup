...
def main(args):
  ...
  try:
    ...
    for j in range(int(start_value * 10), int(end_value * 10), int(step_size * 10)):
...
if __name__ == '__main__':  
  ...
  parser.add_argument('--angle', type=int, help='angles of exploration', default= 45)
