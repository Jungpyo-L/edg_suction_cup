...
def main(args):
  ...
  # engagePosition =  [-597e-3 + 0e-3, 81e-3 + 10e-3, 30e-3]
  engagePosition =  [-597e-3 - 8e-3, 81e-3 + 17e-3, 30e-3]
  ...
  # Fz_lim = 5
  # Fz_lim = 20
  F_normalThres = [Fz_lim , Fz_lim +0.1]
  # F_normalThres = [50, 60]
  # F_normalThres = 1.5 #1
  Fz_tolerance = 0.1
  args.domeRadius = 40
  args.domeRadius = 20
  args.domeRadius = 9999999
  #================================================================================================
  ...
  adpt_help = adaptMotionHelp(dP_threshold=12, dw = 0.5, d_lat = 0.5e-3, d_z = 0.1e-3)
  ...
  try:
    ...
    file_help.saveDataParams(args, appendTxt='seb_rotational_Fz_deleteMe')
