...
def main(args):
  ...
  engagePosition =  [-587e-3 + 0e-3, 81e-3, 35e-3 - 004e-3]     # for dome tilted
  ...
  try:
    ...
    Rw2 = scipy.linalg.expm(phi0 * omega_hat2)
    ...
    file_help.saveDataParams(args, appendTxt='SDL_deleteMe')
